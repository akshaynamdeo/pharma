...
export class PriceDetailComponent implements OnInit {
  ...
  columnDefs = [
    ...
    {headerName: 'Action', field: 'action',cellRenderer: (params :ICellRendererParams) => { 
    ...
    {headerName: 'Price Status', field: 'priceStatus',cellRenderer: (params :ICellRendererParams) => { 
      // put the value in bold
...
rowData = [
    {make: 'Toyota', model: 'Celica', price: 35000,id:1,edit:true,delete:true,action:true},
    {make: 'Ford', model: 'Mondeo', price: 32000,id:2,edit:true,action:false,priceStatus : true},
    {make: 'Porsche', model: 'Boxter', price: 72000,id:3,edit:true,action:true},
    {make: 'Toyota', model: 'Celica', price: 35000,id:4,edit:false,priceStatus : true},
